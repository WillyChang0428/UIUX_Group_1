...
<template>
  <div class="container py-5">
    ...
    <form @submit.prevent class="pt-3">
      ...
      <section
        v-if="isVerified"
        class="animate-fade form-section list-unstyled d-flex flex-column gap-4 mt-4"
      >
        <h5
          class="section-title text-light mb-1 border-top border-secondary pt-4"
        >
          選擇註冊方式
        </h5>
