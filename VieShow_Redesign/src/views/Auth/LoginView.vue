    ...
    <template #content>
      <div class="login-form-wrapper">
        ...
        <div class="error-text text-danger mb-2" style="min-height: 20px;">
          <span v-if="errorMessage"><i class="fa-solid fa-circle-exclamation me-1"></i>{{ errorMessage }}</span>
        </div>
        ...
        <div 
          class="recaptcha-box d-flex justify-content-between align-items-center mb-4" 
        ...
        <button 
          class="btn btn-primary w-100 fw-bold mb-3 login-btn" 
          @click="handleLogin"
        >
          登入
        </button>
